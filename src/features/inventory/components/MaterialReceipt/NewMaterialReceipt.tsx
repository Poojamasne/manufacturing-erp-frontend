...
import { 
  Tag, Package, Layers, Truck, Hash, 
  Calendar, MapPin, Check, ChevronRight, Save, X, 
  ChevronDown
} from "lucide-react";
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-[2.5rem] p-6 sm:p-8 border border-gray-100 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-black text-slate-500 uppercase tracking-widest px-1">Quantity Received</label>
                <div className="relative group">
