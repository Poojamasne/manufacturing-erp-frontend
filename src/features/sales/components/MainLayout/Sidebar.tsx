...
import { logout } from "../../../auth/ModuleStateFiles/AuthSlice";
    ...
    <div className="w-64 bg-white h-screen border-r border-[#F59E0B30] flex flex-col sticky top-0 overflow-hidden">
      ...
      <div className="shrink-0 p-4 border-t border-gray-100 bg-white">
        <button
          ...
          className="group w-full flex items-center gap-3 px-4 py-3 cursor-pointer rounded-xl text-gray-500 hover:bg-red-50 hover:text-amber-500 transition-all duration-200"
        >
          <img
